...
values."
  (setq-default
    ...
    dotspacemacs-configuration-layers '(
      ...
      syntax-checking
      version-control
      ;; haskell ;; To space consuming can't use at uni
      )
